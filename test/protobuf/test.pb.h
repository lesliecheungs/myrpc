...
class GetFriendListResponse :
 ...
 public:
  ...
  enum : int {
    kFrindListFieldNumber = 2,
    kResultFieldNumber = 1,
  };
  // repeated .fixbug.User frind_list = 2;
  int frind_list_size() const;
  private:
  int _internal_frind_list_size() const;
  public:
  void clear_frind_list();
  ::fixbug::User* mutable_frind_list(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
      mutable_frind_list();
  private:
  const ::fixbug::User& _internal_frind_list(int index) const;
  ::fixbug::User* _internal_add_frind_list();
  public:
  const ::fixbug::User& frind_list(int index) const;
  ::fixbug::User* add_frind_list();
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::InternalMetadataWithArena _internal_metadata_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User > frind_list_;
  ::fixbug::ResultCode* result_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_test_2eproto;
};
...
// repeated .fixbug.User frind_list = 2;
inline int GetFriendListResponse::_internal_frind_list_size() const {
  return frind_list_.size();
}
inline int GetFriendListResponse::frind_list_size() const {
  return _internal_frind_list_size();
}
inline void GetFriendListResponse::clear_frind_list() {
  frind_list_.Clear();
}
inline ::fixbug::User* GetFriendListResponse::mutable_frind_list(int index) {
  // @@protoc_insertion_point(field_mutable:fixbug.GetFriendListResponse.frind_list)
  return frind_list_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >*
GetFriendListResponse::mutable_frind_list() {
  // @@protoc_insertion_point(field_mutable_list:fixbug.GetFriendListResponse.frind_list)
  return &frind_list_;
}
inline const ::fixbug::User& GetFriendListResponse::_internal_frind_list(int index) const {
  return frind_list_.Get(index);
}
inline const ::fixbug::User& GetFriendListResponse::frind_list(int index) const {
  // @@protoc_insertion_point(field_get:fixbug.GetFriendListResponse.frind_list)
  return _internal_frind_list(index);
}
inline ::fixbug::User* GetFriendListResponse::_internal_add_frind_list() {
  return frind_list_.Add();
}
inline ::fixbug::User* GetFriendListResponse::add_frind_list() {
  // @@protoc_insertion_point(field_add:fixbug.GetFriendListResponse.frind_list)
  return _internal_add_frind_list();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::fixbug::User >&
GetFriendListResponse::frind_list() const {
  // @@protoc_insertion_point(field_list:fixbug.GetFriendListResponse.frind_list)
  return frind_list_;
}
