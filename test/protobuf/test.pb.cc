...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_test_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendListResponse, frind_list_),
};
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(::fixbug::LoginRequest)},
  { 7, -1, sizeof(::fixbug::LoginResponse)},
  { 14, -1, sizeof(::fixbug::GetFriendListRequest)},
  { 20, -1, sizeof(::fixbug::ResultCode)},
...
const char descriptor_table_protodef_test_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "bug.ResultCode\022 \n\nfrind_list\030\002 \003(\0132\014.fix"
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_frind_list(), ptr);
            CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* GetFriendListResponse::_InternalSerialize(
  ...
  for (unsigned int i = 0,
      n = static_cast<unsigned int>(this->_internal_frind_list_size()); i < n; i++) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
      InternalWriteMessage(2, this->_internal_frind_list(i), target, stream);
  }
...
// @@protoc_insertion_point(message_byte_size_start:fixbug.GetFriendListResponse)
  ...
  // repeated .fixbug.User frind_list = 2;
  total_size += 1UL * this->_internal_frind_list_size();
  for (const auto& msg : this->frind_list_) {
    total_size +=
...
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.GetFriendListResponse)
  ...
  frind_list_.MergeFrom(from.frind_list_);
  if (from.has_result()) {
    _internal_mutable_result()->::fixbug::ResultCode::MergeFrom(from._internal_result());
  }
}
...
void GetFriendListResponse::InternalSwap(GetFriendListResponse* other) {
  using std::swap;
  _internal_metadata_.Swap(&other->_internal_metadata_);
  frind_list_.InternalSwap(&other->frind_list_);
  swap(result_, other->result_);
}
